...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of FTSegmentedContainerView.'
...
TODO: Add long description of the pod here.
  ...
  s.author           = { 'farabis4m' => 'thahir@farabi.ae' }
  s.source           = { :git => 'https://github.com/farabis4m/FTSegmentedContainerView.git', :tag => s.version.to_s }
  # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'

  s.ios.deployment_target = '8.0'

  s.source_files = 'FTSegmentedContainerView/Classes/**/*'
  
  # s.resource_bundles = {
  #   'FTSegmentedContainerView' => ['FTSegmentedContainerView/Assets/*.png']
  # }
